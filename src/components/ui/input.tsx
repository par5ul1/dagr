...
function Input({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-2 h-9 rounded-md border border-input bg-transparent selection:bg-primary selection:text-primary-foreground dark:bg-input/30 px-3 py-1 shadow-xs transition-[color,box-shadow] focus-within:border-ring focus-within:ring-ring/50 focus-within:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
        className
      )}
    >
      {leftAdornment}
